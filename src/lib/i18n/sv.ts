export const sv = {
  ...
  marketing: {
    ...
    pricing: {
      ...
      monthlyLabel: "30 dagars gratis provperiod",
      monthlyPrice: "Gratis i 30 dagar",
      monthlySub: "Sedan 199 kr/månad · säg upp när som helst",
      monthlyCta: "Skapa er familjeplats",
      annualBadge: "Grundarfamiljer",
      annualLabel: "Grundarpris",
      annualPrice: "199 kr / månad",
      annualSub: "Per familj · obegränsat med vårdgivare · låst för alltid · senare familjer 299 kr",
      annualCta: "Gå med tidigt — lås 199",
