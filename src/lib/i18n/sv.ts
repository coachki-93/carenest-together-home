export const sv = {
  ...
  marketing: {
    ...
    pricing: {
      ...
      sub: "Varje familj börjar med 30 dagars gratis provperiod. Grundarfamiljer som börjar före 31 dec 2026 låser priset 199 kr/månad för alltid.",
    ...
    about: {
      ...
      p8: "Varje familj börjar med 30 dagars gratis provperiod. Grundarfamiljer som börjar före 31 dec 2026 låser 199 kr/månad för alltid; familjer som ansluter senare betalar 299 kr/månad — ett abonnemang per familj, obegränsat med vårdgivare.",
      ...
      faq: {
        ...
        q2A: "Varje familj får 30 dagars gratis provperiod. Därefter kostar det 199 kr/månad för grundarfamiljer som ansluter före 31 dec 2026 — låst för alltid — eller 299 kr/månad för familjer som ansluter senare. Månadsvis, ett abonnemang per familj, obegränsat med vårdgivare, säg upp när som helst.",
  ...
  admin: {
    ...
    analytics: {
      title: "Analys",
      subtitle: "Skrivskyddad sammanställning av abonnemang och intäkter. Ingen hälsodata.",
      mrr: "MRR",
      arr: "ARR",
      mrrNote: "MRR räknar bara aktiva abonnemang: grundare × 199 kr + standard × 299 kr.",
      activeFounding: "Aktiva — grundare",
      activeStandard: "Aktiva — standard",
      statusActive: "Aktiva",
      statusTrialing: "Provperiod",
      statusPastDue: "Förfallen betalning",
      statusCanceled: "Avslutade",
      statusNone: "Utan abonnemang",
      signups30d: "Nya senaste 30 dagarna",
      trialsEnding: "Provperioder som slutar inom 7 dagar",
      scheduledCancels: "Schemalagda uppsägningar",
      emptyTrials: "Inga provperioder slutar inom 7 dagar.",
      emptyCancels: "Inga uppsägningar är schemalagda.",
      colFamily: "Familj",
      colTrialEnds: "Provperiod slutar",
      colPeriodEnd: "Aktiv till",
      familySubTitle: "Abonnemang — {{name}}",
      familySubNone: "Ingen abonnemangspost för den här familjen.",
      subStatus: "Status",
      subPlan: "Plan",
      subCustomerId: "Stripe-kund",
      subSubscriptionId: "Stripe-abonnemang",
      subPeriodEnd: "Nuvarande periods slut",
      subCancelScheduled: "Uppsägning schemalagd",
      diag: {
        title: "Diagnostik",
        lastActive: "Senast aktiv",
        never: "Ingen aktivitet registrerad",
        pushTitle: "Notisprenumerationer",
        registered: "Push registrerad",
        notRegistered: "Ingen pushenhet",
        lastSeen: "senast sedd",
        noMembers: "Inga medlemmar i den här familjen.",
        attemptsTitle: "Senaste påminnelseförsök",
        noAttempts: "Inga sändningsförsök registrerade.",
        note: "Sändningsförsök visar att Tillsa försökte skicka en påminnelse. Det finns inget leveranskvitto, så ett försök bevisar inte att telefonen visade den.",
      },
    },
    bugs: {
      title: "Felrapporter",
  ...
  billing: {
    ...
    card: {
      ...
      foundingLocked: "Grundarpris — låst för alltid, startat före 31 dec 2026.",
