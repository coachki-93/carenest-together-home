export const sv = {
  ...
  meds: {
    ...
    totalDosesHelp: "Från receptet. CareNest lägger ut dem på tiderna du angett.",
  ...
  marketing: {
    ...
    about: {
      ...
      p1: "CareNest föddes i en familj där ett barn behöver komplex vård hemma.",
      ...
      p4: "När familjen letade efter ett verktyg som kunde samla allt på ett tryggt och enkelt sätt hittade de inget som faktiskt var byggt för deras verklighet. Därför började vi bygga CareNest.",
      ...
      p6: "Idag utvecklas CareNest tillsammans med familjerna som använder det — föräldrar, mor- och farföräldrar, assistenter och sjuksköterskor. Människor som varje dag delar på ett stort ansvar och behöver kunna lita på att viktig kunskap följer med när någon annan tar över.",
      p7: "CareNest formas av verkliga behov, inte av vad som ser bra ut i en app. Målet är enkelt: att samla det viktigaste på ett ställe, skapa tryggare överlämningar och göra vardagen lite lättare för alla som hjälper till.",
      p8: "CareNest är fortfarande under utveckling och gratis för våra första familjer.",
  ...
  featuresV2: {
    ...
    handovers: {
      ...
      sub: "När ett skift slutar samlar CareNest det som faktiskt hände — överhoppade doser, avvikande värden, syrgas, sjukhusdagar — och ger det till nästa person.",
