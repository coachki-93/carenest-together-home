export const en = {
  ...
  marketing: {
    ...
    problem: {
      ...
      newHandoverTitle: "Night shift · 22:00 → 06:00",
      newHandoverBy: "Written by Ryan",
      newHandoverRead: "Read by Kim",
      newCaption: "Every action carries the caregiver's name and the exact time.",
    },
    forWhom: {
      kicker: "Who it's for",
    ...
    outcomes: {
      ...
      vignette: {
        ...
        oxLabel: "Oxygen",
        oxFlow: "2 L/min",
        oxRemaining: "≈ 1 h 42 min remaining",
        hoTitle: "Night shift · 06:00",
        hoBy: "Written by Ryan",
        hoReadBy: "Read by Kim, Gabriella",
    ...
    essentials: {
      ...
      i1: "Today's plan — the whole day on one screen, done/skip/postpone with one tap",
      i2: "Medication schedule — times, doses, routes; every action logged",
      i3: "Shared calendar — appointments and recurring routines the whole team sees",
      i4: "Care instructions — how-to guides written once, read by every new caregiver",
      i5: "Emergency info — the critical card, one tap away, always current",
    ...
    complex: {
      ...
      i1: "Vitals with age-adjusted ranges & streak alerts",
      i2: "Oxygen countdown matched to manufacturer tables, with hospital pause",
      i3: "Machines & maintenance — filters, tubing, parts on their own schedules",
      i4: "Care Place Control — your checklists at your times; critical answers alert instantly",
      i5: "Inventory with low-stock warnings feeding the shopping list",
    ...
    team: {
      ...
      body:
        "CareNest works whether care is family-only or shared with personal assistants. Teams can share one account with individual caregiver profiles — each shift starts with \"Who's working this shift?\", and every dose, check and filter change is recorded with a name — \"Given by Ryan, 14:30\", not \"someone on the account\". Handovers show who has read them. For the family, that means trust without checking up; for the team, it means their work is visible.",
    ...
    about: {
      ...
      title: "Built with families, for families.",
