export const en = {
  ...
  marketing: {
    ...
    essentials: {
      ...
      i5: "Emergency info",
      i6: "Care team — invite with a code; owners, caregivers, viewers with the right access",
    ...
    about: {
      ...
      p1: "CareNest exists because I needed it. I have a child who requires complex care at home, and the knowledge that kept him safe lived where it always does — in one parent's head. The dose times, the oxygen math, the small routines nobody has written down. Never really off duty, and every new caregiver meant teaching everything again.",
      p2: "When I looked for a system that could hold it together, there wasn't one. So this became the goal: first, that my own child gets the care he needs — then, that every family in the world has the same opportunity. We're building CareNest together with families of children with special needs — parents, grandparents, personal assistants and nurses who take turns doing the hardest, quietest work — shaped by what they say they're missing, not by what looks good in an app.",
