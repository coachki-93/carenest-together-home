export const en = {
  ...
  marketing: {
    ...
    problem: {
      ...
      body1:
        "The dose times. The oxygen math. When the filter was last changed. What the new assistant hasn't been told yet. Which supplies are about to run out. In most families, all of it lives in one parent's head — and that parent can never really be off duty.",
      body2:
