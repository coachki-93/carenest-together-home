export const en = {
  ...
  marketing: {
    ...
    about: {
      ...
      p1: "CareNest exists because the knowledge that keeps a medically complex child safe usually lives in one parent's head — the dose times, the oxygen math, the small routines nobody has written down. That parent is never really off duty, and every new caregiver means teaching everything again.",
      p2: "We're building CareNest with families of children with special needs — parents, grandparents, personal assistants and nurses who take turns doing the hardest, quietest work. It's shaped by what real families said they were missing, not by what an app looked good with.",
