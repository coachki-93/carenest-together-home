export const en = {
  ...
  meds: {
    ...
    totalDosesHelp: "From the prescription label. CareNest lays them out on the times you set.",
  ...
  marketing: {
    ...
    pricing: {
      ...
      monthlyLabel: "30-day free trial",
      monthlyPrice: "Free for 30 days",
      monthlySub: "Then 199 kr/month · cancel anytime",
      monthlyCta: "Create your family space",
      annualBadge: "Founding families",
      annualLabel: "Founding rate",
      annualPrice: "199 kr / month",
      annualSub: "Per family · unlimited caregivers · locked for life · later families 299 kr",
      annualCta: "Join early — lock in 199",
