export const en = {
  ...
  marketing: {
    ...
    about: {
      ...
      p1: "CareNest began in a family with a child who needs complex care at home. For years, one parent was the system — the dose times, the oxygen math, the small routines nobody had written down. Never really off duty. And every time a new caregiver started, a whole life had to be taught again, from memory, at the kitchen table.",
      p2: "When that family went looking for something to hold it all together, nothing good existed. So we started building it ourselves — first so our own child gets the care he needs, then because every family carrying this should have the same chance. Today CareNest is built together with the families who use it: parents, grandparents, assistants and nurses taking turns at the hardest, quietest work. It's shaped by what they say is missing — not by what looks good in an app.",
      p3: "It's still small, still growing, and still free while our first families use it every day. If it helps one shift feel less lonely, we're on the right track.",
