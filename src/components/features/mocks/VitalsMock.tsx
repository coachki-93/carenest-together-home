...
const DATA: Record<PeriodKey, Dataset> = {
  ...
  "7d": {
    readings: [
      { t: 0.000, v: 90, time: "Mon" },
      { t: 1 / 6, v: 88, time: "Tue" },
      { t: 2 / 6, v: 93, time: "Wed" },
      { t: 3 / 6, v: 91, time: "Thu" },
      { t: 4 / 6, v: 89, time: "Fri" },
      { t: 5 / 6, v: 94, time: "Sat" },
      { t: 1.000, v: 92, time: "Sun" },
    ],
    avg: 91, min: 88, max: 94, outOfRange: 0, latest: 92,
    rel: { en: "today", sv: "idag" },
    summary: { en: "Last 7 days · avg 91 bpm", sv: "Senaste 7 dagar · snitt 91 bpm" },
  },
  "30d": {
    readings: [
      { t: 0.000, v: 89, time: "Wk 1" },
      { t: 0.143, v: 91, time: "" },
      { t: 0.286, v: 87, time: "Wk 2" },
      { t: 0.429, v: 93, time: "" },
      { t: 0.571, v: 90, time: "Wk 3" },
      { t: 0.714, v: 95, time: "" },
      { t: 0.857, v: 88, time: "Wk 4" },
      { t: 1.000, v: 92, time: "now" },
    ],
    avg: 91, min: 87, max: 95, outOfRange: 0, latest: 92,
