...
export const Route = createFileRoute("/_authenticated/caregivers")({
  ...
  component: () => {
    ...
    return (
      <DashboardLayout title={t("nav.caregivers")} subtitle={t("stub.comingSoon")}>
        <div className="card-soft p-10 text-center max-w-xl mx-auto">
          ...
          <h2 className="text-2xl font-extrabold mb-2">{t("nav.caregivers")}</h2>
          <p className="text-muted-foreground">{t("stub.caregiversBody")}</p>
        </div>
      </DashboardLayout>
    );
  },
