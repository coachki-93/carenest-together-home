...
export const Route = createFileRoute("/_authenticated/handover")({
  ...
  component: () => {
    ...
    return (
      <DashboardLayout title={t("nav.handover")} subtitle={t("stub.comingSoon")}>
        <div className="card-soft p-10 text-center max-w-xl mx-auto">
          ...
          <h2 className="text-2xl font-extrabold mb-2">{t("nav.handover")}</h2>
          <p className="text-muted-foreground">{t("stub.handoverBody")}</p>
        </div>
      </DashboardLayout>
    );
  },
