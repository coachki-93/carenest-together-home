...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Tillsa" },
      { title: "Tillsa" },
      {
        name: "description",
        content:
          "Tillsa helps families coordinate care for medically complex children with their caregivers — warm, calm, and built for the tablet.",
      },
      { name: "author", content: "Tillsa" },
      { property: "og:title", content: "Tillsa" },
      {
